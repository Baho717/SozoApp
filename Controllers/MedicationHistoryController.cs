...
namespace SozoApothecary.Controllers
{
    public class MedicationHistoryController : Controller
    {
        ...
        public async Task<IActionResult> Create(MedicationHistory medicationHistory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, MedicationHistory medicationHistory)
        {
